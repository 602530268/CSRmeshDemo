...
#import "CSRRestFirmwareVersionResponse.h"
...
/*!
  CSRRestFirmwareModelApi is a part of the CSR Mesh Api and provides a set of related methods to this Model.
*/
@interface CSRRestFirmwareModelApi: CSRRestBaseApi


/*!
  Get firmwre verison: Upon receiving a FIRMWARE_GET_VERSION the device reponds with a FIRMWARE_VERSION message containing the current firmware version
...
- (NSNumber*) getVersion :(NSString*) tenantId 
     ...
     responseHandler :(void (^)(NSNumber* meshRequestId, CSRRestFirmwareVersionResponse* output, NSError* error, CSRRestErrorResponse* errorResponse))responseBlock;
